...
print("Move forward")
set_attitude(pitch_angle = 10,yaw_angle=0, thrust = 0.5, duration = 3)
print("Hold position for 3 seconds")
set_attitude(duration = 3)

print("Move backward")
set_attitude(yaw_angle=40, thrust = 0.5, duration = 3)
print("Hold position for 3 seconds")
set_attitude(duration = 3)

set_attitude(pitch_angle = -2, thrust = 0.5, duration = 3)
print("Hold position for 3 seconds")
set_attitude(duration = 3)
